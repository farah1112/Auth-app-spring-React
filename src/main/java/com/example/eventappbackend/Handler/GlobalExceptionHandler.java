package com.example.eventappbackend.Handler;
...
import static com.example.eventappbackend.Handler.BusinessErrorCodes.*;
...
public class GlobalExceptionHandler {
 ...
 // invalid data this exception is about
    ...
    public ResponseEntity<ExceptionResponse> handleException(Exception exp) {
       // print the error in the console or the log to undersntand to problem
        exp.printStackTrace();
        return ResponseEntity
                .status(INTERNAL_SERVER_ERROR)
                .body(
